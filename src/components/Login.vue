            ...
            <div class="col-12 xl:col-6" style="border-radius:56px; padding:0.3rem; background: linear-gradient(180deg, white, #18042c 30%);">
                <div class="h-full w-full m-0 py-7 px-4" :style="'border-radius:53px; background: #b6ccde'">
                    <div class="text-center mb-5">
                        ...
                        <div class=" font-medium mb-3" style="font-size:2rem; color:#18042c; font-family: 'Montserrat';">¡Bienvenido a EHA!</div>
                    ...
                    <div class="w-full md:w-10 mx-auto">
                        <label for="usernameId" class="block text-900 text-xl mb-2" style="font-size:1.2rem; color:#18042c; font-family: 'Montserrat';">Añade tu nombre de usuario</label>
                        <InputText v-model="username" name="username" id="usernameId" @keypress.enter="signIn()"
                        :class="{'p-invalid': submitted && error.field === 'username'} + '; w-full mb-2'" placeholder="Username" style="padding:1rem;" />
    ...
    methods: {
        ...
        signIn() {
            ...
            .then((response) => {
                ...
                this.$store.dispatch("adminIn",data.isAdmin)
